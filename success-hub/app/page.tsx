    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F5F1E8] to-white">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  ...
                  guidance and more -- all in one place.
                </p>
              </div>
            </div>
      ...
      <div className="bg-gradient-to-br from-[#F5F1E8] to-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* Important Note with Scroll Button */}
          <div className="bg-white p-6 rounded-2xl shadow-lg border border-[#E26C73]">
            <p className="text-xl font-bold text-[#E26C73] text-center mb-4">
              Completing Onboarding is Mandatory to Make The Sunday Shift™ and Start Co-Working
            </p>
            <div className="flex justify-center">
              <Button
                onClick={scrollToWellnessDashboard}
                className="bg-gradient-to-r from-[#7FB069] to-[#E26C73] hover:from-[#6FA055] hover:to-[#D55A60] text-white font-semibold px-6 py-3"
              >
                Track Your Progress
